...
class HalloweenMannequinHead:
    def __init__(self):
        logging.info("Starting camera + servo test application")
...
#            self._setup_servo()
    ...
    def process_frames_from_stream(self):
        ...
        while True:
            ...
            # test new servo control
            self.servo_controller.set_servo_fraction(0.0)
            #time.sleep(1.0)
            self.servo_controller.set_servo_fraction(0.5)
            #time.sleep(1.0)
            self.servo_controller.set_servo_fraction(1.0)
            #time.sleep(1.0)
            self.servo_controller.set_servo_fraction(0.25)
            #time.sleep(1.0)
            self.servo_controller.set_servo_fraction(0.75)
